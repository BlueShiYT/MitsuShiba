let handler = async(m, { conn, args, usedPrefix }) => {
    ...
    if (new Date - global.db.data.users[m.sender].lastcodereg > 8200000000000000000000000000000000) {
    if (new Date - global.db.data.users[m.sender].lastcodereg < 8200000000000000000000000000000000) throw `Anda sudah mengambill code register, Code register anda sudah kadaluarsa..`
